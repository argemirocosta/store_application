...
public class ConexaoBuilder {
    ...
    public static Conexoes carregarDadosConexao() {
        ...
        if(propriedades.Conexao.equals(Propriedades.Conexoes.LOCALHOST)){
            conexoes.setUrlBanco(AmbienteUtil.obterVariavelAmbiente("STORE_DB_URL_LOCALHOST"));
            conexoes.setUsuario(AmbienteUtil.obterVariavelAmbiente("DB_USUARIO_LOCALHOST"));
            conexoes.setSenha(AmbienteUtil.obterVariavelAmbiente("DB_SENHA_LOCALHOST"));
        }
